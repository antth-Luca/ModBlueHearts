...
public class BlueBloodHudOverlay {
    ...
    public static final IIngameOverlay HUD_BLUE_BLOOD = ((gui, poseStack, partialTick, width, height) -> {
        int x = width / 2; // Centraliza os corações
        int y = height;    // Define a altura
    
        RenderSystem.setShader(GameRenderer::getPositionTexShader);
        RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
    
        int blueBlood = ClientBlueBloodData.getPlayerBlueBlood(); // Obtém o valor atual do blue blood
