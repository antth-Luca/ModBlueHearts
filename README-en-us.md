...
* v.2:
    ...
    * Revitalizing Cry Charm: This item is only available if you have the Curios API installed. Once equipped with this amulet, your blue hearts will gradually be restored;
    * Extra content with the Curios API:
        * Revitalizing Crying Charm: This amulet can be equipped in the Curios 'charm' slot and after doing so, it will regenerate a bit of the blue hearts from time to time.
